...
describe('Testando a API Cacau Trybe', function() {
  ...
  describe('Usando o método GET em /chocolates/search', function() {
    it('Retorna chocolates que contem Mo no nome', async function () {
    ...
    it('Retorna array vazio caso não encontro nenhum chocolate', async function () {
      const response = await chai.request(app).get('/chocolates/search?name=XYZ');
